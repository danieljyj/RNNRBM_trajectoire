"""
This is the first version of rnn_rbm, in which we generate every u_t directly based on the input vector v_t,
...
n_hidden           = n_visible  #The size of the RBM hidden layer
